...
echo "   - Daemon: 'pm2 start dist/daemon.js --name itssue-daemon'"
echo "   - API:    'pm2 start dist/api/webhook-server.js --name itssue-api'"
echo "4. Save PM2 list: 'pm2 save' then 'pm2 startup'"
echo ""
echo "💡 Note: Admin UI (Next.js) is optimized for Vercel deployment."
